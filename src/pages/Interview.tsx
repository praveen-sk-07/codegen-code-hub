      ...
      <div className="container mx-auto px-4">
        <div className="mb-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Prepare for technical and HR interviews with comprehensive resources
            </p>
          </div>
          <Button
            variant="outline"
        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden h-[calc(100vh-220px)]">
          {isLoading && (
            <div className="absolute inset-0 flex items-center justify-center bg-gray-100 dark:bg-gray-900">
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-600 dark:text-gray-400">Loading interview resources...</p>
              </div>
            </div>
          )}
          ...
          >
            <iframe
              key={iframeKey}
              src="https://prepinsta.com/interview-preparation/hr-interview-questions/#ques-***"
